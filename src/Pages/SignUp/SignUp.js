    ...
    return (
        <section>
            <div className="flex flex-col justify-center min-h-screen py-12 sm:px-6 lg:px-8">
                ...
                {
                    loading || updating ? <LoadingRipple /> : <div className="mt-8 sm:mx-auto sm:w-full sm:max-w-md">
                        <div className="px-4 py-8 sm:px-10 border border-gray-50 shadow rounded">
                            <div>
