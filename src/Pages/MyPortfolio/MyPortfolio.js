            ...
            <div className="container mx-auto">
                {
                    ...
                    <div className='my-3'>
                        ...
                        <div className='grid grid-cols-3 md:grid-cols-4 lg:grid-cols-6 items-stretch mt-3 gap-1 justify-center'>
                            {
                                usedTechnologies?.map((tech, index) => <a rel="noreferrer" target='_blank' key={index} href={tech.urlLink} ><img  className='hover:scale-[1.04] duration-200 w-full h-[2.3rem] object-fill inline-block' src={tech?.technologyImg} alt="" /></a>)
                            }
                        </div>
                    </div>
                    <div className='my-5'>
