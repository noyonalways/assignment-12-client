        ...
        <section className='py-10'>
            <div className="container mx-auto px-3">
                ...
                <div className="grid lg:grid-cols-4 gap-10 w-[95%] mx-auto">
                    <div className='text-center bg-base px-24 py-16 shadow-md hover:shadow-lg duration-150 rounded'>
                    ...
                    <div className='text-center bg-base px-24 py-16 shadow-md hover:shadow-lg duration-150 rounded gap-6 lg:gap-0'>
                ...
                <div className='w-[95%] shadow-md mx-auto mt-4 p-4 rounded flex flex-col lg:flex-row justify-between space-y-4 lg:space-x-0'>
                <div >
