    ...
    return (
        <section className='w-full'>
            ...
            <div className="container mx-auto">
                ...
                <div className='flex items-start justify-center h-screen w-full px-5'>
                    <div className="w-[480px] h-auto  rounded-xl shadow-lg">
                        <form className="card-body">
                            ...
                            <div className="form-control">
                                ...
                                <input placeholder='Your ratings' className='text-lg input input-bordered' type="number" name="" id="" />
                            </div>
                            <div className="form-control">
                                <label className="label">
